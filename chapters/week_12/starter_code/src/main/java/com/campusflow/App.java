 ...
 * CampusFlow Web 版入口类。
 *
 * 本文件是 Week 12 作业的参考实现，增加了集成测试支持。
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("║           Week 12 - Integration Tests                   ║");
        System.out.println("╚══════════════════════════════════════════════════════════╝");
        System.out.println();
    ...
    private static void printUsage() {
        ...
        System.out.println();
        System.out.println("Week 12 新增：");
        System.out.println("  - 集成测试：验证前后端通信");
        System.out.println("  - 契约测试：验证 API 契约");
        System.out.println("  - 测试替身：Mock/Stub 示例");
        System.out.println();
