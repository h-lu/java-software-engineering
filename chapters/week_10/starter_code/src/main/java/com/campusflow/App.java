 ...
 * CampusFlow Web 版入口类。
 *
 * 本文件是 Week 10 作业的参考实现，增加了 CORS 配置支持。
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("║           Week 10 - CORS + REST API                      ║");
        System.out.println("╚══════════════════════════════════════════════════════════╝");
        System.out.println();
    ...
    private static void printUsage() {
        ...
        System.out.println("  - 允许方法: GET, POST, PUT, PATCH, DELETE, OPTIONS");
        System.out.println("  - 允许头: Content-Type, Authorization");
        System.out.println();
        ...
        System.out.println("    -H 'Origin: http://localhost:3000' \\");
