...
- `CHAPTER.md`：叙事流畅、有贯穿案例 + CampusFlow 超级线、循环角色出场、回顾桥达标、读起来像真人教材（不是模板填空）
...
- **必须基于第 1.5 步的 Context7 查证结果**确保代码示例使用当前 Java 最佳实践
